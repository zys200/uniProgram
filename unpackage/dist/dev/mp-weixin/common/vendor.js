...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__542B76C",
    appName: "Hbuilder-Uni",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
(function(module2, exports2) {
  (function(root, factory) {
    ...
    PubSub.subscribe = function(message, func2) {
      ...
      messages[message][token] = func2;
      return token;
    };
    PubSub.subscribeAll = function(func2) {
      return PubSub.subscribe(ALL_SUBSCRIBING_MSG, func2);
    };
    PubSub.subscribeOnce = function(message, func2) {
